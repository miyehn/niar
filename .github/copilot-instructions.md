...
`.github/path-to-restir.md`. Minimal RTGI hit shading and direct-lit
secondary-hit shading are complete enough to move on; work is now moving into
Milestone 3's temporal accumulation path.
