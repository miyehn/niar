...
`.github/path-to-restir.md`. Milestone 3's temporal accumulation (ping-pong
history, motion-vector reprojection, depth-based history rejection) is
complete enough to move on; work is now moving into Milestone 4's spatial
filtering.
