...
MatGeneric* GlMaterial::mat_depth_value = nullptr;
MatGeneric* GlMaterial::mat_depth() {
...
std::unordered_map<std::string, GlMaterial*> GlMaterial::material_pool;

void GlMaterial::add_to_pool(const std::string& name, GlMaterial* mat) {
...
GlMaterial* GlMaterial::get(const std::string& name) {
...
void GlMaterial::use(const Drawable* obj) {
